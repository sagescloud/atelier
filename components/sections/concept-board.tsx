...
const conceptImages = [
  ...
  { src: "/images/concept-3.jpg", alt: "Fashion draping on mannequin", x: "left-[22%]", y: "top-[28%]", w: "w-[35%] md:w-[22%]", h: "h-[220px] md:h-[300px]", z: "z-30", rotate: -1, parallaxSpeed: 0.2 },
  { src: "/images/concept-4.jpg", alt: "Architectural column detail", x: "right-[18%]", y: "top-[24%]", w: "w-[38%] md:w-[20%]", h: "h-[190px] md:h-[260px]", z: "z-20", rotate: 2, parallaxSpeed: 0.4 },
